...
const About = () => {
  return (
    <Layout>
      <div className="w-full h-full p-10 pt-0 bg-back-1 ">
        <div className="w-full mx-auto mb-10 md:w-[70%]">
          <h1 className="mb-2 text-4xl font-bold text-center text-c2 md:text-5xl font-f1">
            About US
          </h1>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1  md:w-[90%] w-full gap-6 mx-auto mt-10">
          <div className="flex flex-col items-center w-full p-6 bg-c2 h-fit rounded-2xl">
            ...
            <h1 className="justify-between mb-3 text-sm text-center text-c4 md:text-2xl font-f1">
        ...
        <div className="z-20 flex flex-col w-full px-10 pt-4 pb-6 mx-auto mt-6 shadow-xl bg-c2 md:w-3/4 rounded-xl h-fit">
          <h1 className="justify-between mb-3 text-lg font-bold text-center text-white md:text-2xl font-f1">
            Find us on
          </h1>
