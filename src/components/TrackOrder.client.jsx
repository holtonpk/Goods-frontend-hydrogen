...
const TrackOrder = () => {
  ...
  return (
    ...
    <div className="h-fit bg-c2 rounded-t-2xl w-[90%] mx-auto pt-10 md:pb-20 pb-4">
       
        <div className="flex flex-col justify-between w-full px-3 mx-auto mb-20 md:flex-row md:px-0 md:w-5/6 trackPage h-5/6">
          <div className="flex flex-col gap-4 border-gray-200 md:w-1/2 md:pl-4 md:border-l-2 md:order-1 h-fit">
            <div>
...
<ValidationTextField
        ...
        />
          ...
          <div className="flex flex-col justify-between gap-4 mt-10 md:w-1/2 md:pr-4 h-fit md:mt-0">
            <div>
